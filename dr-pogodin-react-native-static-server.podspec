...
Pod::Spec.new do |s|
  ...
  s.script_phase = {
    ...
    :script => <<-CMD
      ...
      elif [[ ${PLATFORM_FAMILY_NAME} == "tvOS" ]]; then
        EXTRA_CONFIG_ARGS="-DCMAKE_OSX_ARCHITECTURES=arm64;x86_64 -DCMAKE_OSX_DEPLOYMENT_TARGET=${TVOS_DEPLOYMENT_TARGET} -DCMAKE_SYSTEM_NAME=tvOS -GXcode"
        BUILD_OUTPUT_FOLDER_LIGHTTPD="/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}"
        BUILD_OUTPUT_FOLDER_PCRE2="/Release${EFFECTIVE_PLATFORM_NAME}"
      else
